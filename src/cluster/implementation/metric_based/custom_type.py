...
_DTYPE: tp.TypeAlias = np.float64

_MACHINE_SHAPE = _JOB_SHAPE = tuple[_N_RESOURCE, _N_TICKS]
_JOBS_SHAPE: tp.TypeAlias = tuple[_N_JOBS, _N_RESOURCE, _N_TICKS]
_MACHINES_SHAPE = tuple[_N_MACHINES, _N_RESOURCE, _N_TICKS]
