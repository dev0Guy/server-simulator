...
from src.cluster.implementation.deep_rm import DeepRMCluster, DeepRMMachinesConvertor, DeepRMJobsConvertor
...
class DeepRMObservationCreator(BaseObservationCreatorProtocol[DeepRMCluster, DeepRMClusterObservation]):
