...
def random_machine_with_static_machine(
    n_machines: int, n_jobs: int, seed=None
) -> SingleSlotCluster:
...
def static_machine_with_static_machine(
    n_machines: int, n_jobs: int, seed=None, static_value: float = 1.0
) -> SingleSlotCluster:
    return SingleSlotCluster(
